...
bechdel_countriesFail %>%
  mutate(ProzentFail = round((AnzahlFails/Anzahl*100), digits = 2)) -> bechdel_ALL
bechdel_ALL %>%
...
## Gleichberechtigung
Wir, die DataWizards, haben für Euch die 14 spannendsten Länder bereitgestellt. Klick auf unsere Karte oder finde Dein Land über die Menüleiste, um Informationen rund ums Thema Gleichstellung zu finden: Sei es zum [Gleichstellungsindex](Glossar.html) oder zum [Bechdel-Test](Glossar.html).
