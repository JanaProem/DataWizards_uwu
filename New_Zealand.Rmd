...
ggplot(data_kreis, aes(x="", y=n, fill=criteria)) +
      ...
      labs(x = NULL, y = NULL, fill = NULL,
           caption = "Ergebnisse des Bechdel-Test: Anzahl der Filme") +
  theme(
...
```{r}
# Facet Wrap-Vergleich der bestandenen/durchgefallenen Filme pro Genre
bechdel2 %>%
  filter(country == "New Zealand") %>%
  group_by(binary) %>%
