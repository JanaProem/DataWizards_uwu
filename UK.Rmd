...
Nach dem Gleichstellungsindex vom CFR hat England keine Hindernisse in diesem Bereich.
:::
...
Mehr als die Hälfte der Filme besteht den Bechdel-Test nicht. Vor 1980 wurden gar keine Filme produziert, welche ihn bestehen. Ab den 1990er Jahren haben alle Bewertungen zugenommen mit einem allgemeinen Produktionspeak zum Ende der 2000er Jahre.Das häufigste Kriterium, an dem die Filme scheitern, ist, dass die Frauen im Film nicht miteinander reden: Dies trifft auf genau 50% der durchgefallenen Filme zu.
...
Insgesamt gibt es am meisten Drama-Filme, welche ungefähr gleich häufig beim Bechdel-Test durchfallen oder ihn bestehen. Die Filme fast aller Genre fallen teils durch und bestehen teils. Bei machen Genre kann zudem eine Tendenz festgestellt werden; so fallen Action-, Thriller- und Crime-Filme häufiger durch, während Romance-Filme den Test häufiger bestehen.
