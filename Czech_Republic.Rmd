...
Der Großteil der Filme besteht den Bechdel-Test nicht – nur 2 von 13 Filmen erfüllen alle Kriterien. Das häufigste Kriterium, an dem die Filme scheitern, ist, dass die Frauen im Film nicht miteinander reden: Dies trifft auf über 60% der Filme zu.
...
ggsave(p, filename = "images/Kreis_Czech_Republic.png", bg = "transparent")
```
![](images\Kreis_Czech_Republic.png)

Insgesamt gibt es am meisten Action-Filme, wovon bloß knapp über 20% den Bechdel-Test bestehen. Das zweithäufigste Genre ist Thriller, wovon keiner der Filme den Bechdel-Test besteht. Die meisten anderen Genres haben auch eine Durchfallquote von 100%. 
...
## Fazit
Tschechien schneidet beim Gleichstellungsindex gut ab, beim Bechdel-Test jedoch eher schlecht. Das größte Problem stellt hierbei das Kriterium dar, dass Frauen nicht miteinander reden. Die meisten Genres haben eine Durchfallquote von 100%, Ausnahmen bilden hierbei jedoch: Action, Adventure, Fantasy und Family. 
